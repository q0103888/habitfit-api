...
const ja = {
  ...
  "common.durationMinPlaceholder": "時間(分)",
  "common.repUnit": "回",
  "common.addSet": "セット追加",
  "common.setCount": "{n}セット",
  "common.setLine": "{n}セット — {weight}kg x {reps}回",
  "common.setLineDuration": "{n}セット — {duration}分",
  "common.confirm": "確認",
  "common.checking": "確認中...",
  ...
  "dashboard.weeklyVolume": "今週の総ボリューム",
  "dashboard.weeklyVolumeHint": "重量 x 回数の合計",
  ...
  "routine.currentWeek": "今週",
  "routine.backToCurrentWeek": "今週へ",
  ...
  "stats.readyBodyParts": "回復完了部位",
  "stats.currentWeight": "現在の体重",
  "stats.weightLogCount": "体重記録{n}回",
  "stats.deepDiveTitle": "種目別記録推移",
  "stats.currentMax": "現在の最高重量",
  "stats.allTimePr": "自己ベスト",
  "stats.recentVolume": "直近セッションボリューム",
  "stats.sinceStart": "記録開始から",
  "stats.sessionDuration": "セッション別運動時間",
  "stats.currentDuration": "現在のセッション時間",
  ...
  "session.suggestionDuration": "前回 {duration}分",
  ...
  "auth.heroTitle": "記録が積み重なれば、成長が見える。",
  "auth.heroSubtitle": "ルーティン管理、統計、AIコーチをひとつのアプリで。今日のトレーニングから記録を始めましょう。",
  "auth.featureRoutine": "週間ルーティンとカレンダー管理",
  "auth.featureStats": "3大種目の記録と部位別回復状態の追跡",
  "auth.featureAi": "AIコーチにいつでも質問",
...
const ko: Record<Key, string> = {
  ...
  "common.durationMinPlaceholder": "시간(분)",
  "common.repUnit": "회",
  "common.addSet": "세트 추가",
  "common.setCount": "{n}세트",
  "common.setLine": "{n}세트 — {weight}kg x {reps}회",
  "common.setLineDuration": "{n}세트 — {duration}분",
  "common.confirm": "확인",
  ...
  "dashboard.weeklyVolume": "이번 주 총 볼륨",
  "dashboard.weeklyVolumeHint": "무게 x 횟수의 합",
  ...
  "routine.currentWeek": "이번 주",
  "routine.backToCurrentWeek": "이번 주로",
  ...
  "stats.readyBodyParts": "회복 완료 부위",
  "stats.currentWeight": "현재 체중",
  "stats.weightLogCount": "체중 기록 {n}회",
  "stats.deepDiveTitle": "종목별 기록 추이",
  "stats.currentMax": "현재 최고 중량",
  "stats.allTimePr": "역대 최고 기록",
  "stats.recentVolume": "최근 세션 볼륨",
  "stats.sinceStart": "기록 시작 대비",
  "stats.sessionDuration": "세션별 운동 시간",
  "stats.currentDuration": "현재 세션 시간",
  ...
  "session.suggestionDuration": "지난번 {duration}분",
  ...
  "auth.heroTitle": "기록이 쌓이면, 성장이 보입니다.",
  "auth.heroSubtitle": "루틴 관리, 통계, AI 코치를 한 앱에서. 오늘의 운동부터 기록을 시작해보세요.",
  "auth.featureRoutine": "주간 루틴과 캘린더 관리",
  "auth.featureStats": "3대 운동 기록과 부위별 회복 상태 추적",
  "auth.featureAi": "AI 코치에게 언제든 질문",
