...
public record ExerciseResponse(Long id, String bodyPart, String name, String displayName, String imageUrl) {
    ...
    static ExerciseResponse from(Exercise exercise, String locale) {
        ...
        return new ExerciseResponse(
                exercise.getId(), exercise.getBodyPart(), exercise.getName(), displayName, exercise.getImageUrl());
    }
}
